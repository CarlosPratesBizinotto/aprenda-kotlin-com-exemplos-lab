...
fun main() {
    ...
    val cursoJavaScript = ConteudoEducacional("Introdução ao JavaScript", 180)
    
    // Cria uma instância de Formacao
    val formacao = Formacao("Programação", listOf(cursoKotlin, cursoJava, cursoJavaScript))
    
    // Cria algumas instâncias de Usuario
    val usuario1 = Usuario("Andrea", "andrea@gmail.com", 1)
    val usuario2 = Usuario("Gabriela", "gabriela@gmail.com", 2)
    val usuario3 = Usuario("Theo", "theo@gmail.com", 3)
	...
	println("Duração do curso de JavaScript: ${cursoJavaScript.duracao} minutos")
	println()
